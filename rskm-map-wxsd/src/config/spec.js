...
let waySpec = [
    ...
    {
        id: "procjet_wxsd_dk_xiaomai",
        name: "保单地块",
        "type": "fill",
        source: config.procjet_wxsd_dk_xiaomai.name,
        "source-layer": config.procjet_wxsd_dk_xiaomai.name,
        minzoom: 7.4,
        "filter": [
            // ">",
            // ["get", "bili"], 0  // 筛选出 value 大于 0 的数据
            "any",
            [
              "all",
              [">", ["get", "bili"], 0]
    ...
    {
        id: "procjet_wxsd_dk_xiaomai_outline",
        name: "保单地块外框",
        type: "line",
        source: config.procjet_wxsd_dk_xiaomai.name,
        "source-layer": config.procjet_wxsd_dk_xiaomai.name,
    ...
    {
        id: "procjet_wxsd_dk_xiaomai_name",
        type: "symbol",
        source: config.procjet_wxsd_dk_xiaomai.name,
        "source-layer": config.procjet_wxsd_dk_xiaomai.name,
        layout: {
