                ...
                <a-table :columns="columnsDk" :data-source="dataSourceDk" bordered size="middle" :scroll="{ y: 540 }"
                    ...
                    <template #bodyCell="{ column, record }">
                        ...
                        <template v-if="column.key === 'bdh'">
                            保单号:{{ record.bdh }} <br>
                            保险期间:{{ dayjs(record.bdscsj).format('YYYY/MM/DD') + '-' +
                                dayjs(record.bdxgsj).format('YYYY/MM/DD') }}
                        </template>
                    ...
                    <a-card size="small" title="">
                        ...
                        <p style="border-bottom: 1px solid #ccc;">
                            <label style="font-size: 16px;">
                                <FoldersIcon :size="20" style="margin-bottom: -5px;"></FoldersIcon> 遥感核验
                            </label>
                        ...
                        <Download :size="16"></Download>
                                        ...
                                        <td> <a-button type="link" primary>
                                                <div style="display: flex;align-items: center;">
                                                    <Download :size="16"></Download>&nbsp; <a
                                                        :href="'/data/阿荣旗遥感核验_区域数据_20241104.xlsx'" download>下载核验报表</a>
                                                </div>
                                            </a-button>
                            ...
                            <a-row :gutter="16">
                                ...
                                <a-col :span="6">
                                    ...
                                    <a-statistic title="地块面积" :value="Number(cbmj).toFixed(0)" class="demo-class">
                                    </a-statistic>


                                </a-col>
                                <a-col :span="6">
                                    <a-statistic title="遥感面积" :value="Number(ygmj).toFixed(0)" class="demo-class">
                            ...
                            <div style="width: 100%;height: 55%;">
                                <div class="headerbg">
                                    ...
                                    <a-button type="link" primary style="position: absolute;right: 10px;"
                                        @click="open = true">
                                        <div style="display: flex;align-items: center;">
                                            <MoreHorizontal :size="18"></MoreHorizontal>&nbsp;保单详情
                                        </div>
                                    </a-button>
                            ...
                            <table style="position: absolute;right: 10px;margin-top: -30px">
                                <tr>
                                    ...
                                    <td> <a-button type="link" primary>
                                            <div style="display: flex;align-items: center;">
                                                <Download :size="16"></Download>&nbsp; <a
                                                    :href="'/data/阿荣旗遥感核验_地块数据_20241104.xlsx'" download>下载核验报表</a>
                                            </div>
                                        </a-button>
