(function (global, factory) {
    ...
    function RasterTileLayer (layerId, layerType, options) {
        ...
        var providers = {
            ...
            JLONE: {
                Satellite: {
                    Map: "https://api.jl1mall.com/getMap/{z}/{x}/{y}?mk=2d9bf902749f1630bc25fc720ba7c29f&tk=4804cc51cb77b4304a780449b6db6b9b",
                    minzoom: 3,
                    maxzoom: 18
                },
                Subdomains: [""],
            ...
            //http://map.ruimap.cn/maps/vt/lyrs=s@113&hl=nl&x=[x]&y=[y]&z=[z]
            Google: {
                Satellite: {
                    Map: "http://map.ruimap.cn/maps/vt/lyrs=s@113&hl=nl&x={x}&y={y}&z={z}",
                    minzoom: 3,
                    maxzoom: 20
                },
                Subdomains: [""],
