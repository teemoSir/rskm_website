...
// 默认任务名称
const taskName = ref(`富江县-玉米-${dayjs("2024-06-01").format('YYMMDD')}-遥感核验`)
                ...
                <a-descriptions layout="vertical" bordered size="small" v-for="item in taskData"
                  ...
                  <a-descriptions-item :label="item.title">
                    ...
                    <a-tooltip>
                      ...
                      <BookX style=" cursor: pointer;position: absolute;right: 30px;margin-top: -25px"
